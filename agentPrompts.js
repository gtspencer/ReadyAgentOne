...
exports.QuestSchema = exports.MessageSchema = void 0;
const Persona = "";
exports.MessageSchema = `You will speak to different nifty island players. Each message will be in the form 
...
exports.QuestSchema = `Players can ask you to stream island to them. You are to give them a quest so they can prove worthy of it.
