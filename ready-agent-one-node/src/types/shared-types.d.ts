 ...
 */
export declare const PLAYER_ENTER_EVENT = "PLAYER_ENTER";
export declare const PLAYER_EXIT_EVENT = "PLAYER_EXIT";
export declare const PLAYER_WON_EVENT = "PLAYER_WON";
export declare const GAME_COMPLETED_EVENT = "GAME_COMPLETED";
export type EventName = typeof PLAYER_ENTER_EVENT | typeof PLAYER_EXIT_EVENT | typeof PLAYER_WON_EVENT | typeof GAME_COMPLETED_EVENT | string;
/**
