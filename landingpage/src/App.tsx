    ...
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-[#1d1d1f] relative">
      <MouseParallaxContainer className="min-h-screen relative overflow-hidden">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            <MouseParallaxChild factorX={0.01} factorY={0.01} className="relative -translate-y-6">
              <h1 className="text-5xl font-bold mb-2 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                ReadyAgentOne
              </h1>
            </MouseParallaxChild>
            <MouseParallaxChild factorX={0.015} factorY={0.015} className="relative -translate-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
            ...
            >
              <MouseParallaxChild factorX={0.02} factorY={0.02} className="relative -translate-y-6">
              ...
              <MouseParallaxChild factorX={0.03} factorY={0.03} className="relative translate-y-6">
                <div className="relative">
                  <label className="flex items-center text-lg mb-3 text-gray-800 dark:text-white">
...
Initiating position scaling strategy...`}
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, y: 0 }}
        className="fixed bottom-0 left-1/2 -translate-x-1/2 pointer-events-none z-10"
      >
        <img
          src="/agent.png"
          alt="Agent Character"
